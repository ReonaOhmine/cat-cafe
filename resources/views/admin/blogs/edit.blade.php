                ...
                <div class="pt-4 px-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <input id="image" class="block w-full px-4 py-3 mb-2" type="file" accept='image/*' name="image" value=" {{old('image',$blog->image)}} ">
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="js-pulldown" class="mr-6 w-full" name="cats[]" multiple>
                            <option value="">選択してください</option>
                            @foreach($cats as $cat)
                            <option value="{{ $cat->id}}"  @if(in_array($cat->id, old('cat',$blog->cats->pluck('id')->all())))  selected @endif >{{$cat->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
